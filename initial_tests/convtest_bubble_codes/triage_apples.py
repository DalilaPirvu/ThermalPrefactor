...
tempList, massq, right_Vmax, V, dV, Vinv, nTimeMAX, minSim, maxSim, alphaList = general
temp, m2, sigmafld, maxSim = get_model(*general, tmp, case='free')
exp_params = np.array([nLat, m2, alphaList[alchoice], temp])
